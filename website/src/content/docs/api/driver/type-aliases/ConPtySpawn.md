...
[@termwright/driver](../../) / ConPtySpawn

# Type Alias: ConPtySpawn

> **ConPtySpawn** = (`options`) => [`ConPtySessionHandle`](../../interfaces/conptysessionhandle/)

Defined in: [driver/src/conpty-backend.ts:43](https://github.com/Gorce-AI/termwright/blob/main/packages/driver/src/conpty-backend.ts#L43)
