...
[@termwright/driver](../../) / createConPtyBackend

# Function: createConPtyBackend()

> **createConPtyBackend**(`spawn`): [`PtyBackend`](../../interfaces/ptybackend/)

Defined in: [driver/src/conpty-backend.ts:63](https://github.com/Gorce-AI/termwright/blob/main/packages/driver/src/conpty-backend.ts#L63)
