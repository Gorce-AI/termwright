...
Defined in: [test/src/config.ts:110](https://github.com/Gorce-AI/termwright/blob/main/packages/test/src/config.ts#L110)
...
Defined in: [test/src/config.ts:112](https://github.com/Gorce-AI/termwright/blob/main/packages/test/src/config.ts#L112)
