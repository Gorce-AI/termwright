...
[@termwright/gherkin](../../) / gherkinPlugin

# Function: gherkinPlugin()

> **gherkinPlugin**\<`Fixtures`\>(`options?`): `Plugin`

Defined in: [plugin.ts:617](https://github.com/Gorce-AI/termwright/blob/main/packages/gherkin/src/plugin.ts#L617)
