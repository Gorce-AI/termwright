...
[@termwright/driver/experimental](../../) / RefQuery

# Interface: RefQuery

Defined in: [selectors.ts:69](https://github.com/Gorce-AI/termwright/blob/main/packages/driver/src/selectors.ts#L69)
...
Defined in: [selectors.ts:70](https://github.com/Gorce-AI/termwright/blob/main/packages/driver/src/selectors.ts#L70)
