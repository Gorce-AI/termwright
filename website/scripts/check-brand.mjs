...
const canonicalIcon = new URL('../../assets/brand/termwright-icon.svg', import.meta.url);
const canonicalLogo = new URL('../../assets/brand/termwright-logo.svg', import.meta.url);
