...
import {
  literalLeafTitles,
  literalPlatformSkips,
  validateExactSkipReferences,
} from './check-platform-deviations.mjs';
  ...
  it('rejects missing, duplicate and cross-file leaf references', () => {
    ...
    expect(() =>
      validateExactSkipReferences(
        ...
        undefined,
        new Map([
          ['exact.test.ts', "it('duplicate', () => {}); test.only('duplicate', () => {});"],
        ]),
      ),
  ...
  it('validates required applicability leaves but permits optional generated suites', () => {
    const applicability = {
      ...
      rules: [
        ...
        {
          id: 'generated',
          file: 'factory-caller.test.ts',
          fullName: 'factory leaf',
          required: false,
        },
      ],
    };
