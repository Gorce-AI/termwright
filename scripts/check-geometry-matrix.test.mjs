...
describe('generated geometry and certification reference', () => {
  it('renders framework rows from the supplied compatibility registry without changing prose', async () => {
    ...
    opentui.name = 'OpenTUI synthetic render test';
    ...
    expect(page).not.toContain(opentui.name);
    expect(rendered).toContain(`| ${opentui.name} |`);
