...
export function buildMissionCompletionReport() {
  return {
    ...
    baselineHead: '6f4ea467e6a8fd2b7789d9eb955557a414f0f59d',
    policy: {
    ...
    postMergeRegressionEvidence: {
      ...
      status: 'resolved; retained as historical failure evidence',
      resolution:
        'The generation-bound correction is present in the final certified tree and completed both the PR and post-merge 41/41 first-attempt certification runs.',
      classification: [
    ...
    finalCertificationEvidence: {
      ...
      pr: {
        ...
        jobsTotal: 41,
        conclusion: 'success',
        url: 'https://github.com/Gorce-AI/termwright/actions/runs/33311771962',
        observedAt: '2026-08-30',
      },
      postMerge: {
        runId: '33312798807',
        headSha: '6f4ea467e6a8fd2b7789d9eb955557a414f0f59d',
        runAttempt: 1,
        jobsPassed: 41,
        jobsTotal: 41,
        conclusion: 'success',
        url: 'https://github.com/Gorce-AI/termwright/actions/runs/33312798807',
        observedAt: '2026-08-30',
      },
      classification: [
        'The reviewed PR head and squash-merged main commit have the same Git tree.',
        'Both independent workflow executions completed all 41 jobs successfully on attempt 1; no rerun supplied release evidence.',
        'The matrix repeated Linux, macOS and Windows Node 22/24 builds, Windows x64/ARM64 native PTY contracts, lifecycle stress, framework conformance, Bun OpenTUI, deterministic coverage and 50 native cycles, resource/leak barriers, examples, clients, website and release hygiene.',
      ],
    },
    ...
    windowsBackendEvidence: {
      ...
      classification: [
        ...
        'The unified package defines six prebuilds for Darwin, Linux and Windows on x64 and arm64; the final certification and release matrices exercise and materialize the native implementations, while the one-time npm bootstrap workflow emits only dependency-free, immediately deprecated registry placeholders from an authorized default-branch SHA. npm transiently assigns each first publication to latest until the full GitHub release replaces it.',
