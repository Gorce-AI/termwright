...
export default defineSteps<ProjectFixtures>(
  ...
  Given<ProjectFixtures>('the project fixture is available', async ({ defer, expect, projectFixture, world }) => {
    await Promise.resolve();
  ...
  When<ProjectFixtures>('the project fixture owns a scenario resource', async ({ projectFixture, use }) => {
    await Promise.resolve();
  ...
  Then<ProjectFixtures>('every step has received the same project fixture', async ({ expect, projectFixture, world }) => {
    await Promise.resolve();
