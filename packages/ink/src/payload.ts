 ...
 *
 * @throws TypeError when props contain something JSON cannot carry
 ...
 *
 * @throws TypeError naming the path of the first value that cannot
 */
...
function reject(path: string, reason: string): TypeError {
  return new TypeError(
    `fixture prop ${path} ${reason}; fixture props are transferred as JSON, everything else has to stay in-process`,
  );
}
