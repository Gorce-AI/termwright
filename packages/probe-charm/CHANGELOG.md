...
- [#106](https://github.com/Gorce-AI/termwright/pull/106) [`e0b78f5`](https://github.com/Gorce-AI/termwright/commit/e0b78f525888014f8ea08d3817abbeb407c3df6e) Thanks [@SarukMyskam](https://github.com/SarukMyskam)! - Certify Bubble Tea v2.0.9 with an exact checksummed render-boundary profile and real Bubbles v2.1.1 composition coverage.

- [#109](https://github.com/Gorce-AI/termwright/pull/109) [`7915ac1`](https://github.com/Gorce-AI/termwright/commit/7915ac1b6a9dfc906d900e0760a7f3385e216383) Thanks [@SarukMyskam](https://github.com/SarukMyskam)! - Make Bubbles capability certification deterministic while preserving fail-closed compiler validation.
...
- [#106](https://github.com/Gorce-AI/termwright/pull/106) [`e0b78f5`](https://github.com/Gorce-AI/termwright/commit/e0b78f525888014f8ea08d3817abbeb407c3df6e) Thanks [@SarukMyskam](https://github.com/SarukMyskam)! - Harden Bubbles capability-profile selection with an offline compiler contract so
  admission no longer depends on network availability or Go module-cache warming.

- [#106](https://github.com/Gorce-AI/termwright/pull/106) [`e0b78f5`](https://github.com/Gorce-AI/termwright/commit/e0b78f525888014f8ea08d3817abbeb407c3df6e) Thanks [@SarukMyskam](https://github.com/SarukMyskam)! - Recover transient Bubble Tea semantic-publication pressure through one
  coalesced event-loop replay of the current model and a real renderer flush.
  Shutdown now fails closed when the final semantic revision cannot be published.
