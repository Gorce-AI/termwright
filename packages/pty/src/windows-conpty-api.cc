...
constexpr std::array<unsigned char, 32> kDllDigest = {
    0xa9, 0x4d, 0xac, 0x7c, 0x62, 0x9f, 0xab, 0xf6, 0x48, 0xe7, 0xcd,
    0x0e, 0x9e, 0x31, 0x84, 0xd8, 0x75, 0x5b, 0xeb, 0xa5, 0xb4, 0xd2,
    0x9f, 0x26, 0xdb, 0x68, 0x9c, 0x82, 0x33, 0x2a, 0x9d, 0xac};
#elif defined(_M_ARM64)
constexpr std::array<unsigned char, 32> kDllDigest = {
    0xde, 0xbf, 0x08, 0xd5, 0x67, 0xc3, 0x0d, 0xcb, 0x22, 0x18, 0x3b,
    0x82, 0x89, 0xa6, 0xb9, 0x87, 0xfc, 0xd8, 0x19, 0xc7, 0xee, 0x7f,
    0x5f, 0xa8, 0x59, 0xca, 0xc8, 0x10, 0x97, 0x91, 0x71, 0xc8};
#endif

#if defined(_M_X64)
constexpr std::array<unsigned char, 32> kX64HostDigest = {
    0xa3, 0x83, 0xa0, 0xc5, 0xb8, 0x21, 0x9f, 0x73, 0x8b, 0x7e, 0x3b,
    0xc2, 0x50, 0x53, 0xcc, 0xd2, 0x48, 0x3b, 0xa5, 0xc3, 0xa6, 0xf3,
    0x33, 0x8d, 0xde, 0x31, 0xd7, 0xba, 0x0f, 0x20, 0xde, 0x08};
#endif
constexpr std::array<unsigned char, 32> kArm64HostDigest = {
    0x87, 0xac, 0x8d, 0x5a, 0x4b, 0x80, 0x8e, 0xee, 0xc5, 0x9f, 0xfc,
    0x82, 0x74, 0xdf, 0x17, 0xba, 0x74, 0xc5, 0x51, 0x2c, 0x50, 0xfb,
    0x53, 0xbf, 0xf6, 0xb4, 0xda, 0xa8, 0x0d, 0xc2, 0x50, 0xb8};
