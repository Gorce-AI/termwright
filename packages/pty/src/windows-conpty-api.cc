...
constexpr std::array<unsigned char, 32> kDllDigest = {
    0xf9, 0x5d, 0x34, 0xc6, 0xf4, 0x76, 0x45, 0xde, 0xcb, 0x1d, 0x96,
    0xc0, 0xeb, 0x49, 0x2c, 0xde, 0x14, 0xa8, 0x8a, 0x87, 0x0d, 0x0e,
    0x6c, 0x70, 0x80, 0xc5, 0x08, 0x19, 0x1d, 0x28, 0x78, 0xe3};
#elif defined(_M_ARM64)
constexpr std::array<unsigned char, 32> kDllDigest = {
    0x5d, 0x05, 0x6f, 0x02, 0x8d, 0xbf, 0x66, 0x32, 0x34, 0x28, 0xa9,
    0xb8, 0x6c, 0x93, 0x6e, 0x2d, 0xa3, 0x19, 0xdb, 0x85, 0xb1, 0xc7,
    0x5e, 0xa7, 0xc8, 0xc7, 0xfc, 0xae, 0xbf, 0xd0, 0xc4, 0xdd};
#endif

#if defined(_M_X64)
constexpr std::array<unsigned char, 32> kX64HostDigest = {
    0x37, 0xe1, 0x67, 0xe3, 0x87, 0x49, 0xfc, 0xd7, 0x24, 0x4f, 0x77,
    0x06, 0x32, 0x87, 0x5c, 0xbc, 0x3e, 0x6c, 0x72, 0x70, 0x6d, 0xe8,
    0xa0, 0x1b, 0xa1, 0x57, 0x89, 0xbc, 0xb0, 0xed, 0x85, 0xb1};
#endif
constexpr std::array<unsigned char, 32> kArm64HostDigest = {
    0x90, 0xd6, 0xcf, 0x1a, 0x7f, 0x68, 0xcf, 0x83, 0x2b, 0x6c, 0xaf,
    0xf8, 0x2e, 0x8b, 0x09, 0x16, 0x41, 0xf6, 0x41, 0xea, 0xd8, 0x66,
    0x4f, 0xa0, 0xe6, 0x84, 0xcc, 0x3b, 0x75, 0x97, 0x19, 0xbd};
