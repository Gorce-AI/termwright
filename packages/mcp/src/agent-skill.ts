...
function renderSkillMarkdown(): string {
  return [
    ...
    'is opt-in because unmarked secrets printed by the program may remain in output. Typed input',
    'and sensitive semantic values are redacted; command arguments are withheld.',
