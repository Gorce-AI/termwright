...
- [#28](https://github.com/Gorce-AI/termwright/pull/28) [`db12601`](https://github.com/Gorce-AI/termwright/commit/db12601b2c62114f8775ae0ac41571a987f62bdd) Thanks [@SarukMyskam](https://github.com/SarukMyskam)! - Compile the owned, add-only tcell marker capability only for native Windows
...
- [#89](https://github.com/Gorce-AI/termwright/pull/89) [`74252bf`](https://github.com/Gorce-AI/termwright/commit/74252bfc61dfd333128b34055b683b5d862e5f9e) Thanks [@SarukMyskam](https://github.com/SarukMyskam)! - Detect the tcell Windows marker capability from the framework-owned console handle instead of the removed private `cScreen.vten` field, including causal legacy Console API conformance on vendored ConPTY.
