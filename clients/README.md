...
| ------------------------------- | -------------------------------------------------- | ---------------------------------------------------------- |
| [`python/`](python)             | `termwright` 0.7.2 (PyPI)                          | protocol client + automatic Textual probe + annotation SDK |
| [`go/`](go)                     | `github.com/gorce-ai/termwright/clients/go` v0.7.2 | protocol client + Go annotation SDK                        |
| [`rust/`](rust)                 | `termwright-protocol` 0.7.2 (crates.io)            | protocol client                                            |
| [`rust-probe/`](rust-probe)     | `termwright-probe-ratatui` 0.7.2                   | exact-version Ratatui build probe                          |
| [`rust-ratatui/`](rust-ratatui) | `termwright-ratatui` 0.7.2                         | author-intent SDK for custom Ratatui widgets               |
